      ...
      <DialogContent className="grid grid-cols-2 gap-8 sm:p-12 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw]">
        ...
        <div className="">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-muted-foreground">({avgReviews.toFixed(1)})</span>
          </div>
          <div className="my-5">
          ...
          <div className="max-h-[300px] overflow-hidden">
            <h2 className="text-xl font-bold mb-4">Reviews({reviewtList?.length || 0})</h2>
            <div className="grid gap-6 max-h-20 overflow-hidden overflow-y-scroll">
              {reviewtList && reviewtList?.length > 0 && (
